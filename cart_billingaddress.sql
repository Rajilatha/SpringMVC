...
CREATE TABLE `billingaddress` (
  ...
  KEY `FKF0492D1925642173` (`customer_customerId`),
  CONSTRAINT `FKF0492D1925642173` FOREIGN KEY (`customer_customerId`) REFERENCES `customer` (`customerId`)
...
-- Dump completed on 2021-01-11 18:44:32
